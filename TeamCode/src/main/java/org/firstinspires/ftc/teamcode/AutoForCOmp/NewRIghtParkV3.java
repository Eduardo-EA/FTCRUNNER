...
@Config
@Autonomous
public class NewRIghtParkV3 extends LinearOpMode
{
 ...
 */
        ...
        TrajectorySequence park2 = drive.trajectorySequenceBuilder(new Pose2d(39.04, -63.21, Math.toRadians(90.00)))
                ...
                .lineToLinearHeading(new Pose2d(33.5, -4.5, Math.toRadians(138.24))) // turns torwards junction and move forward
                .waitSeconds(1)
                .addTemporalMarker(3, () -> {
                    // This marker runs two seconds into the trajectory
                    LiftMotor.setPower(0);
