package org.firstinspires.ftc.teamcode.AutoForCOmp.FourBArLIft;
...
@TeleOp(name="helpmeeplease", group="Linear Opmode")
public class fourbartele extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        RightFrontDrive = hardwareMap.get(DcMotor.class, "4");
        LeftFrontDrive = hardwareMap.get(DcMotor.class, "3");
        RightBackDrive = hardwareMap.get(DcMotor.class, "2");
        LeftBackDrive = hardwareMap.get(DcMotor.class, "1");

        LiftMotor = hardwareMap.get(DcMotor.class, "L");
        LiftMotor2 = hardwareMap.get(DcMotor.class,"R");


        RightServo = hardwareMap.get(Servo.class, "r");
        LeftServo = hardwareMap.get(Servo.class, "l");
