...
@Config
@Autonomous
public class RIght3ConeAuto extends LinearOpMode
{
 ...
 */
        ...
        TrajectorySequence park3 = drive.trajectorySequenceBuilder(new Pose2d(39.04, -63.21, Math.toRadians(90.00)))
                ...
                .lineToLinearHeading(new Pose2d(32,-11.5, Math.toRadians(90)))
              ...
              //  .lineToLinearHeading(new Pose2d(34.64, -11.50, Math.toRadians(90))) //\.a goes and park


               // .lineToLinearHeading(new Pose2d(55.5,-12.5, Math.toRadians(30))) // parks in zone 3 use this one
